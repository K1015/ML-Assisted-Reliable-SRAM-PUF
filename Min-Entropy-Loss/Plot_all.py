...
plt.savefig('Min_Entropy_and_Uni_wrt_Temp.pdf', format='pdf', transparent=True,bbox_inches='tight',dpi=200)
plt.show()
...
plt.legend(loc='upper center', ncol=1,bbox_to_anchor=(0.48, 1.38),prop={'size': 32, 'family':'Arial'}         
            ,edgecolor='black',columnspacing=0.3,handlelength=1.0,handletextpad=0.5)
plt.savefig('Min_Entropy_Loss_wrt_Temp.pdf', format='pdf', transparent=True,bbox_inches='tight',dpi=200)
plt.show()
