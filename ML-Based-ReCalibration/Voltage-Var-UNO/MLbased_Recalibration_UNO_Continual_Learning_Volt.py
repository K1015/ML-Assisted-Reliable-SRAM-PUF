...
for predVolt in Volt_range:
    ...
    for board in BoardRange:      
        ...
        testInd = np.where(Volt_all==predVolt)[0][0]
...
np.save(path + 'CorrectedResp_UNO_TrasferLearning_Volt.npy',CorrectedResp) 
np.save(path + 'WindowErrorPredAcc_UNO_TransferLearning_Volt.npy',wAcc) 